...
% ------------------------------------------------------------------------------
data.problem.Path = 'Transport/x2y2_Solution';
data.problem.Name = '';
...
data.Neutronics.Transport.ExtSource{1,1} = @RHSFunc_x2y2Solution;
data.Neutronics.Transport.ExactSolution{1,1} = @ExactSol_x2y2Solution;
% Boundary Conditions
data.Neutronics.Transport.BCFlags = [glob.Function];
data.Neutronics.Transport.BCVals{1,1} = @ExactAngSol_x2y2Solution;
