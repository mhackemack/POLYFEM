...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [A,B] = func_mat_IP(lam, input)
% Copy Input Space
% ----------------
data = input.data;
mesh = input.mesh;
...
for f=1:mesh.TotalFaces
    ...
    if fid == 0
        ...
        A(fn1,fn2) = A(fn1,fn2) - k*MM2*PMf2; % (-,+)
        A(fn2,fn1) = A(fn2,fn1) - k*M1*PMf1;  % (+,-)
        A(fn2,fn2) = A(fn2,fn2) + k*MM2*PMf2; % (+,+)
        % ( {{Du}} , [[b]] )
