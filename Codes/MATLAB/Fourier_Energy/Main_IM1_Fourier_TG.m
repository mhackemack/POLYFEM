...
% ------------------------------------------------------------------------------
func_P0_noaccel = get_TG_fourier_func('unaccelerated',0);
func_P0_accel   = get_TG_fourier_func('accelerated',0);
func_P1_noaccel = get_TG_fourier_func('unaccelerated',1);
func_P1_accel   = get_TG_fourier_func('accelerated',1);
% ------------------------------------------------------------------------------
...
% Print output files
cell2csv([glob.output_path,data.OutputName,'/Fourier_TG_P0_noaccel'],P0_noaccel_out);
cell2csv([glob.output_path,data.OutputName,'/Fourier_TG_P0_accel'],P0_accel_out);
cell2csv([glob.output_path,data.OutputName,'/Fourier_TG_P1_noaccel'],P1_noaccel_out);
cell2csv([glob.output_path,data.OutputName,'/Fourier_TG_P1_accel'],P1_accel_out);
