%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%   Title:          Modified Two-Grid Collapsing
%
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function data = collapse_mtg_xs(data,xsin,xsout,accid)
global glob
...
for m=1:nm
    A = (diag(txs(m,:)) - tril(squeeze(sxs(m,:,:)),-1))\triu(squeeze(sxs(m,:,:)),0);
...
% ------------------------------------------------------------------------------
if data.Acceleration.Info(accid).AccelerationType == glob.Accel_AGS_MTG
...
elseif data.Acceleration.Info(accid).AccelerationType == glob.Accel_AGS_MTTG
