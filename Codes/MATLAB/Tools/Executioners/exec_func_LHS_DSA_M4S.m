%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%   Title:          Get M4S DSA System Matrix
%
%   Author:         Michael W. Hackemack
%   Institution:    Texas A&M University
%   Year:           2015
%   
%   Description:    Retrieves the M4S system matrix for a 1-group problem. It is
%                   assumed that the cross sections have been properly handled
%                   prior to this function call.
%   
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function A = exec_func_LHS_DSA_M4S(data,accel_id,xsid,mesh,DoF,FE)
global glob
% Retrieve M4S DSA System Matrix
