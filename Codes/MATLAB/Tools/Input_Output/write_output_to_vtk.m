function write_output_to_vtk(filename, data, mesh, DoF, sol, sol_name)
...
if refbool
    reflvl = mesh.get_refinement_level();
...
fid1 = fopen(str_mesh,'w+');
fid2 = fopen(str_sol,'w+');

% Print Basic Information
fprintf(fid1,'# vtk DataFile Version 3.0 \n');
fprintf(fid1,'Date: %d/%d/%d   Time: %d:%d\n', m, d, y, h, mi);
fprintf(fid1,'ASCII \n');
fprintf(fid1,'DATASET UNSTRUCTURED_GRID \n');
fprintf(fid1,' \n');
fprintf(fid2,'# vtk DataFile Version 3.0 \n');
fprintf(fid2,'Date: %d/%d/%d   Time: %d:%d\n', m, d, y, h, mi);
fprintf(fid2,'ASCII \n');
fprintf(fid2,'DATASET UNSTRUCTURED_GRID \n');
fprintf(fid2,' \n');

if dim == 1
    write_1D_output_to_vtk(fid1,fid2,mesh,DoF,sol,sol_name);
elseif dim == 2
    write_2D_output_to_vtk(fid1,fid2,mesh,DoF,sol,sol_name);
elseif dim==3
    write_3D_output_to_vtk(fid1,fid2,mesh,DoF,sol,sol_name);
end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function write_1D_output_to_vtk(fid1,fid2,mesh,DoF,sol,sol_name)


return
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function write_2D_output_to_vtk(fid1,fid2,mesh,DoF,sol,sol_name)
% Write Mesh Output
% -----------------
...
return
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function write_3D_output_to_vtk(fid1,fid2,mesh,DoF,sol,sol_name)
