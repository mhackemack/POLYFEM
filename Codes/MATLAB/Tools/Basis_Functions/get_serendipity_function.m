...
elseif deg == 2
    out = [(1-s).*(1-t).*(1-2*s-2*t),...
            ...
            4*t.*(1-s).*(1-t)];
elseif deg == 3
    out = [(1-s).*(1-t).*(1-3*s-3*t).*(1-3/2*s-3/2*t),...
           s.*(1-t).*(1-3*s+3*t).*(1-3/2*s+3/2*t),...
           s.*t.*(4-3*s-3*t).*(5-3*s-3*t)./2,...
           (1-s).*t.*(1+3*s-3*t).*(2+3*s-3*t)./2,...
           9*s.*(1-s).*(1-t).*(1-3/2*s),...
           -9/2*s.*(1-s).*(1-t).*(1-3*s),...
           9*s.*t.*(1-t).*(1-3/2*t),...
           -9/2*s.*t.*(1-t).*(1-3*t),...
...
elseif deg == 2
    out = [ - 2*(s - 1)*(t - 1) - (t - 1)*(2*s + 2*t - 1), - 2*(s - 1)*(t - 1) - (s - 1)*(2*s + 2*t - 1);...
                     (t - 1)*(2*t - 2*s + 1) - 2*s*(t - 1),               2*s*(t - 1) + s*(2*t - 2*s + 1);...
                                 2*s*t + t*(2*s + 2*t - 3),                     2*s*t + s*(2*s + 2*t - 3);...
                           2*t*(s - 1) + t*(2*s - 2*t + 1),         (s - 1)*(2*s - 2*t + 1) - 2*t*(s - 1);...
                           4*(s - 1)*(t - 1) + 4*s*(t - 1),                                   4*s*(s - 1);...
                                              -4*t*(t - 1),                         - 4*s*t - 4*s*(t - 1);...
                                     - 4*s*t - 4*t*(s - 1),                                  -4*s*(s - 1);...
                                               4*t*(t - 1),               4*(s - 1)*(t - 1) + 4*t*(s - 1)];
elseif deg == 3
    out = [ (3*(s - 1)*(t - 1)*(3*s + 3*t - 1))/2 + 3*(s - 1)*(t - 1)*((3*s)/2 + (3*t)/2 - 1) + (t - 1)*(3*s + 3*t - 1)*((3*s)/2 + (3*t)/2 - 1), (3*(s - 1)*(t - 1)*(3*s + 3*t - 1))/2 + 3*(s - 1)*(t - 1)*((3*s)/2 + (3*t)/2 - 1) + (s - 1)*(3*s + 3*t - 1)*((3*s)/2 + (3*t)/2 - 1);...
                         (3*s*(t - 1)*(3*t - 3*s + 1))/2 - (t - 1)*(3*t - 3*s + 1)*((3*t)/2 - (3*s)/2 + 1) + 3*s*(t - 1)*((3*t)/2 - (3*s)/2 + 1),                 - (3*s*(t - 1)*(3*t - 3*s + 1))/2 - 3*s*(t - 1)*((3*t)/2 - (3*s)/2 + 1) - s*(3*t - 3*s + 1)*((3*t)/2 - (3*s)/2 + 1);...
                                                   (3*s*t*(3*s + 3*t - 4))/2 + (3*s*t*(3*s + 3*t - 5))/2 + (t*(3*s + 3*t - 4)*(3*s + 3*t - 5))/2,                                       (3*s*t*(3*s + 3*t - 4))/2 + (3*s*t*(3*s + 3*t - 5))/2 + (s*(3*s + 3*t - 4)*(3*s + 3*t - 5))/2;...
                                     - (3*t*(s - 1)*(3*s - 3*t + 1))/2 - (3*t*(s - 1)*(3*s - 3*t + 2))/2 - (t*(3*s - 3*t + 1)*(3*s - 3*t + 2))/2,                     (3*t*(s - 1)*(3*s - 3*t + 1))/2 - ((s - 1)*(3*s - 3*t + 1)*(3*s - 3*t + 2))/2 + (3*t*(s - 1)*(3*s - 3*t + 2))/2;...
                                                        - 9*((3*s)/2 - 1)*(s - 1)*(t - 1) - (27*s*(s - 1)*(t - 1))/2 - 9*s*((3*s)/2 - 1)*(t - 1),                                                                                                          -9*s*((3*s)/2 - 1)*(s - 1);...
                                                          (9*(3*s - 1)*(s - 1)*(t - 1))/2 + (27*s*(s - 1)*(t - 1))/2 + (9*s*(3*s - 1)*(t - 1))/2,                                                                                                           (9*s*(3*s - 1)*(s - 1))/2;...
                                                                                                                       9*t*((3*t)/2 - 1)*(t - 1),                                                                (27*s*t*(t - 1))/2 + 9*s*t*((3*t)/2 - 1) + 9*s*((3*t)/2 - 1)*(t - 1);...
                                                                                                                      -(9*t*(3*t - 1)*(t - 1))/2,                                                              - (27*s*t*(t - 1))/2 - (9*s*t*(3*t - 1))/2 - (9*s*(3*t - 1)*(t - 1))/2;...
                                                                          - (27*s*t*(s - 1))/2 - (9*s*t*(3*s - 1))/2 - (9*t*(3*s - 1)*(s - 1))/2,                                                                                                          -(9*s*(3*s - 1)*(s - 1))/2;...
                                                                            (27*s*t*(s - 1))/2 + 9*s*t*((3*s)/2 - 1) + 9*t*((3*s)/2 - 1)*(s - 1),                                                                                                           9*s*((3*s)/2 - 1)*(s - 1);...
                                                                                                                       (9*t*(3*t - 1)*(t - 1))/2,                                       t*((9*s)/2 - 9/2)*(3*t - 1) + ((9*s)/2 - 9/2)*(3*t - 1)*(t - 1) + 3*t*((9*s)/2 - 9/2)*(t - 1);...
                                                                                                                      -9*t*((3*t)/2 - 1)*(t - 1),                                           - t*(9*s - 9)*((3*t)/2 - 1) - (9*s - 9)*((3*t)/2 - 1)*(t - 1) - (3*t*(9*s - 9)*(t - 1))/2];
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
