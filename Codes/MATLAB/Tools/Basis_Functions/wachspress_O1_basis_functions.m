%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%   Title:          Linear Wachspress Basis Function Generator
%
...
%                   values using the linear Wachspress methodology.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%   Notes:
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function varargout = wachspress_O1_basis_functions(varargin)
nout = nargout;
...
% ------------------------------------------------------------------------------
[nv, dim] = size(verts);
if order ~= 1, error('1st order in this functor only.'); end
if nv ~= nverts, error('Something does not align. Go check your code.'); end
