...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function varargout = max_entropy_basis_functions(varargin)
...
if order == 1
    if ~grad_bool
        ...
        [bout, gout] = max_entropy_O1_basis_functions(verts, qx, faces, order, nverts);
    end
elseif order == 2
    if ~grad_bool
        bout = max_entropy_O2_basis_functions(verts, qx, faces, order, nverts);
    else
