%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%   Title:          Simplex Serendipity Main Generation Function
%
...
%                   set outputs for the Serendipity basis functions on simplexes
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function varargout = bf_cell_func_Serendipity_Simplex( varargin )
...
% -----------------------------------
ref_val_func = get_serendipity_function('vals', 1, dim);
ref_grad_func = get_serendipity_function('grads', 1, dim);
