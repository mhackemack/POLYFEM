%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%   Title:          Mean Value Basis Function Generator - Surface Integrals
%
...
%                   the mean value basis functions.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%   Note:
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function varargout = mean_value_surface( varargin )
...
if dim < 2, error('Mean Value Coordinates only defined for 2D/3D.'); end
...
% ---------------------------------------
if flags(2)
    [bme, gme] = mean_value_basis_functions(verts, qx, faces, order, nverts);
else
    bme = mean_value_basis_functions(verts, qx, faces, order, nverts);
end
